...
// Stripe library
require 'payment/stripe/Stripe.php';

$params = array(
	"testmode"   => "on",
	//"private_live_key" => "sk_live_xxxxxxxxxxxxxxxxxxxxx",
	//"public_live_key"  => "pk_live_xxxxxxxxxxxxxxxxxxxxx",
	"private_test_key" => "sk_test_dgBMxtXyigHEprP719XaDupj",
	"public_test_key"  => "pk_test_YjfBC2cM8gZPCcJ02i1UyYtf"
);
...
if(isset($_POST['stripeToken']))
{
	...
	$message = "<BR>Stripe Payment Status : ".$result;
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="Stripe">Credi/Debit Card</option>
	                                        <option value="PayPal"><?php echo LANG_VALUE_36; ?></option>
	                                        <option value="Bank Deposit"><?php echo LANG_VALUE_38; ?></option>
	                                    </select>
	                                </div>
	                                <div id="stripe_form" style="margin-left: 17px;">
	                                	<link href="payment/stripe/style.css" type="text/css" rel="stylesheet" />
